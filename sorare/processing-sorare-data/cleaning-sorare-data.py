...
# save cleaned df
sorare_filtered_df.to_csv('sorare/sorare_data/test_cleaned_sorare_data.csv', index=False)
grouped_df.to_csv('sorare/sorare_data/test_grouped_sorare_data.csv', index=False)
